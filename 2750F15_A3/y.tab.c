...
{
      15,     0,    -1,    16,    -1,    16,    17,    -1,    -1,    19,
      -1,    18,    -1,     3,    12,    -1,    20,    21,    22,    24,
       9,    23,    25,    12,    -1,    20,    21,    22,    24,    12,
      -1,     8,    -1,    -1,     4,    -1,    11,    -1,    -1,    11,
      -1,    -1,    26,    -1,    -1,    26,    -1,    -1,    26,    27,
      26,    -1,     5,    26,     6,    -1,    10,    -1,    13,    -1,
       7,    -1
};
...
{
       0,    75,    75,    76,    77,    79,    79,    83,    86,    87,
      90,    97,   100,   103,   103,   105,   105,   107,   107,   110,
     110,   113,   115,   117,   118,   135
};
#endif
...
{
  "$end", "error", "$undefined", "TOK_BEGIN", "TOK_OPCODE", "TOK_OB",
  "TOK_CB", "TOK_OPERATOR", "TOK_SLABEL", "TOK_COMMA", "TOK_DIGIT",
  "TOK_ADDMODE", "TOK_SEMICOLON", "TOK_LABEL", "$accept", "final",
  "commands", "command", "begin_stmt", "full_stmt", "label_stmt",
  "opcode_stmt", "faddmode_stmt", "saddmode_stmt", "fdigit_stmt",
  "sdigit_stmt", "expression_stmt", "operator_stmt", 0
};
#endif
...
{
       4,     0,     2,     1,     0,    10,     3,     6,     5,     0,
       7,    12,    14,    13,    18,     0,    23,    24,     0,    17,
       0,    16,     9,    25,     0,    22,    15,    20,    21,     0,
      19,     8
};
...
{
     -16,     1,     0,   -16,     3,   -16,   -16,   -16,   -16,     9,
     -16,   -16,     5,   -16,    -3,    -3,   -16,   -16,     2,    10,
      -1,     7,   -16,   -16,    -3,   -16,   -16,    -3,    10,     8,
      10,   -16
};
...
{
      20,     3,    15,     4,   -11,    25,    23,    16,     5,    28,
      17,    21,    30,    11,    22,    10,    13,    23,    26,     0,
      31
};

static const yytype_int8 yycheck[] =
{
      15,     0,     5,     3,     4,     6,     7,    10,     8,    24,
      13,     9,    27,     4,    12,    12,    11,     7,    11,    -1,
      12
};
...
{
       0,    15,    16,     0,     3,     8,    17,    18,    19,    20,
      12,     4,    21,    11,    22,     5,    10,    13,    24,    26,
      26,     9,    12,     7,    27,     6,    11,    23,    26,    25,
      26,    12
};
  ...
  switch (yyn)
    {
        case 2:
#line 75 "parse.y"
    {if(mode ==1){ writeCodemonFile();}  lines = 0;}
    break;

  case 7:
#line 83 "parse.y"
    {if(mode ==1){makeBegin(yylval.digit);}}
    break;

  case 8:
#line 86 "parse.y"
    {if(mode ==1){if(storageLine.firstDigit > 8192 || storageLine.secondDigit > 8192)
		{return 1;} makeBinaryInstruction(); codemonProgram[lines] = storageLine.binaryInstruction;} lines++;}
    break;

  case 9:
#line 87 "parse.y"
    {if(mode ==1){fillValues(); makeBinaryInstruction(); codemonProgram[lines] = storageLine.binaryInstruction;} lines++;}
    break;
...
#line 90 "parse.y"
  ...
  case 12:
#line 100 "parse.y"
    {if(mode ==1){ storageLine.opcode = readOpcode(yylval.opcode);} free(yylval.opcode);}
    break;

  case 13:
#line 103 "parse.y"
    {if(mode ==1){ storageLine.firstAddMode = readAddressMode(yylval.addMode);}}
    break;

  case 14:
#line 103 "parse.y"
    {if(mode ==1){storageLine.firstAddMode = 0;}}
    break;

  case 15:
#line 105 "parse.y"
    {if(mode ==1){storageLine.secondAddMode = readAddressMode(yylval.addMode);}}
    break;

  case 16:
#line 105 "parse.y"
    {if(mode ==1){storageLine.secondAddMode = 0;}}
    break;

  case 17:
#line 107 "parse.y"
    {if(mode ==1){ if(tempDigit < 0){changeNegativeVal();} storageLine.firstDigit = tempDigit;  hasVal = 0;}}
    break;

  case 18:
#line 107 "parse.y"
    {if(mode ==1){ storageLine.firstDigit = 0;}}
    break;

  case 19:
#line 110 "parse.y"
    {if(mode ==1){if(tempDigit < 0){changeNegativeVal();} storageLine.secondDigit = tempDigit; hasVal = 0;}}
    break;

  case 20:
#line 110 "parse.y"
    {if(mode ==1){ storageLine.secondDigit = 0;}}
    break;
...
#line 117 "parse.y"
    {if(mode ==1){
	if(hasVal == 0){tempDigit = yylval.digit; hasVal = 1;}else{tempDigitTwo = yylval.digit; evalExpression(); }}}
    break;
